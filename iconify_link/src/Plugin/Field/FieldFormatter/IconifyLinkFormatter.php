...
namespace Drupal\iconify_link\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'iconify_link' formatter.
 *
 * @FieldFormatter(
 *   id = "iconify_link",
 ...
 * )
 */
class IconifyLinkFormatter extends LinkFormatter {
    ...
    foreach ($items as $delta => $item) {
      ...
      if (!empty($settings['url_only']) && !empty($settings['url_plain'])) {
        ...
        if (!empty($options['attributes']['data-icon'])) {
          $link_title = $this->iconify($link_title)->setIcon($options['attributes']['data-icon']);
        }
